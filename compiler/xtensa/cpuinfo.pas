...
Const
 ...
 const
   cpu_capabilities : array[tcputype] of set of tcpuflags =
     (
       { cpu_none     } [],
       { cpu_lx106    } [CPUXTENSA_HAS_32BITMUL],
       { cpu_lx6      } [CPUXTENSA_REGWINDOW, CPUXTENSA_HAS_SEXT, CPUXTENSA_HAS_BOOLEAN_OPTION, CPUXTENSA_HAS_32BITMUL]
     );
