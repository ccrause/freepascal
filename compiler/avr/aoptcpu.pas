              ...
              case taicpu(p).opcode of
                ...
                A_STS:
                  if (taicpu(p).oper[0]^.ref^.symbol=nil) and
                    ...
                    (((current_settings.cputype in [cpu_avrxmega3, cpu_avrtiny]) and
                      (taicpu(p).oper[0]^.ref^.offset>=0) and
                      (taicpu(p).oper[0]^.ref^.offset<=63)) or
                     (not(current_settings.cputype in [cpu_avrxmega3, cpu_avrtiny]) and
                    ...
                    begin
                      ...
                      if current_settings.cputype in [cpu_avrxmega3, cpu_avrtiny] then
                ...
                A_LDS:
                  if (taicpu(p).oper[1]^.ref^.symbol=nil) and
                    ...
                    // avrxmega3/avrtiny doesn't map registers into data space so no offset to subtract
                    (((current_settings.cputype in [cpu_avrxmega3, cpu_avrtiny]) and
