...
type
  ...
  const
    ...
    CALSEL20M0idx = $06;  // Calibration freq select
    CALSEL20M1idx = $07;  // Calibration freq select
  ...
  const
    ...
    ASYNCUSER40idx = $00;  // synchronous User Ch 4 Input Selection - CCL LUT0 Event 1
    ASYNCUSER41idx = $01;  // synchronous User Ch 4 Input Selection - CCL LUT0 Event 1
    ASYNCUSER42idx = $02;  // synchronous User Ch 4 Input Selection - CCL LUT0 Event 1
    ASYNCUSER43idx = $03;  // synchronous User Ch 4 Input Selection - CCL LUT0 Event 1
    ASYNCUSER44idx = $04;  // synchronous User Ch 4 Input Selection - CCL LUT0 Event 1
    ASYNCUSER45idx = $05;  // synchronous User Ch 4 Input Selection - CCL LUT0 Event 1
    ASYNCUSER46idx = $06;  // synchronous User Ch 4 Input Selection - CCL LUT0 Event 1
    ASYNCUSER47idx = $07;  // synchronous User Ch 4 Input Selection - CCL LUT0 Event 1
    ...
    SYNCUSER00idx = $00;  // Synchronous User Ch 0 Input Selection - TCA0
    SYNCUSER01idx = $01;  // Synchronous User Ch 0 Input Selection - TCA0
    SYNCUSER02idx = $02;  // Synchronous User Ch 0 Input Selection - TCA0
    SYNCUSER03idx = $03;  // Synchronous User Ch 0 Input Selection - TCA0
    SYNCUSER04idx = $04;  // Synchronous User Ch 0 Input Selection - TCA0
    SYNCUSER05idx = $05;  // Synchronous User Ch 0 Input Selection - TCA0
    SYNCUSER06idx = $06;  // Synchronous User Ch 0 Input Selection - TCA0
    SYNCUSER07idx = $07;  // Synchronous User Ch 0 Input Selection - TCA0
    SYNCUSER10idx = $00;  // Synchronous User Ch 1 Input Selection - USART0
    SYNCUSER11idx = $01;  // Synchronous User Ch 1 Input Selection - USART0
    SYNCUSER12idx = $02;  // Synchronous User Ch 1 Input Selection - USART0
    SYNCUSER13idx = $03;  // Synchronous User Ch 1 Input Selection - USART0
    SYNCUSER14idx = $04;  // Synchronous User Ch 1 Input Selection - USART0
    SYNCUSER15idx = $05;  // Synchronous User Ch 1 Input Selection - USART0
    SYNCUSER16idx = $06;  // Synchronous User Ch 1 Input Selection - USART0
    SYNCUSER17idx = $07;  // Synchronous User Ch 1 Input Selection - USART0
  end;
  ...
  const
    FMPENidx = $01;  FMPENbm = $02;  // FM Plus Enable
    SDAHOLD0idx = $02;  // SDA Hold Time
    SDAHOLD1idx = $03;  // SDA Hold Time
    SDASETUPidx = $04;  SDASETUPbm = $10;  // SDA Setup Time
    DBGRUNidx = $00;  DBGRUNbm = $01;  // Debug Run
